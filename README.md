...
# 0531springboot基于 html5 的图书管理系统--论文pf

![picture](https://raw.githubusercontent.com/GraduationProject-springboot/.github/main/img/wx.png)

### 点击播放视频 ▼
[![Watch the video](https://i.sstatic.net/Vp2cE.png)](https://www.bilibili.com/video/BV1eMbYemE1U?p=33)


# 第1章 绪论
## 1.1选题动因
当前的网络技术，软件技术等都具备成熟的理论基础，市场上也出现各种技术开发的软件，这些软件都被用于各个领域，包括生活和工作的领域。随着电脑和笔记本的广泛运用，以及各种计算机硬件的完善和升级，市面上的电脑和笔记本的性能都得到提升，可以支持的软件也逐渐增多，因此，在计算机上安装软件来发挥其高效地信息处理的作用，则很受人们的青睐。对于图书管理系统信息来讲，通过手工形式处理，在面对庞大的信息数量时，就显得不适宜了，首先需要花费的时间比较多，其次数据出错率比较高，而且对错误的数据进行更改也比较困难，最后，检索数据费事费力。因此，为了解决上述问题，有必要建立图书管理系统，来规范图书管理系统信息管理流程，让管理工作可以系统化和程序化，同时，图书管理系统的有效运用可以帮助管理人员准确快速地处理信息。
## 1.2目的和意义
...
# 第2章 开发环境与技术
开发图书管理系统需要搭建编程的环境，也需要通过调查，对各个相关技术进行分析，选取适合本系统开发的技术与工具。
## 2.1 MYSQL数据库
...
### 3.1.1操作可行性分析
开发本系统需要用到的工具，本人都比较熟悉，因此可以使用这些工具，完整开发图书管理系统。此外，图书管理系统在功能上，基本都是完成信息的处理，涵盖了添加，修改，删除等，而且操作者面对的都是各个功能操作界面，并不是编码后台，所以一般的使用者都可以通过操作界面轻松完成信息的加工处理。因此，本系统操作可行。
### 3.1.2经济可行性分析
...
### 3.1.3技术可行性分析
本系统需要的软件包括Eclipse，Tomcat，Mysql等，这些工具都接触并使用过，至于JAVA，B/S，vue，Html等技术，图书馆都有对应的书籍可以参考学习，加上平时课堂上学习的编程小项目对这些技术都有讲解，另外，本人也从课程设计作业中锻炼了编程能力。所以在技术上，可以完成图书管理系统的编程开发。

通过上面的分析，已经确定了本系统在经济上的可行，本系统在技术上的可行，本系统在操作上的可行。由此，可以得出在目前的条件下，对于图书管理系统的设计与实现是可以进行下去的。
## 3.2系统流程分析
...
图3.3 查询信息流程图
## 3.3系统性能分析
分析图书管理系统对于性能的需求主要还是从下面的5个角度来分析，它们分别是系统的实用性，系统的适应性，系统的易操作性，系统的安全性和系统的易维护性。
...
![C:/Users/Administrator/Desktop/temp111\1\\_\_\_\_img\出入库详情.jpg](/md/blog.005.jpeg "C:/Users/Administrator/Desktop/temp111\1\\_\_\_\_img\出入库详情.jpg")
出入库详情实体属性图
...
![C:/Users/Administrator/Desktop/temp111\1\\_\_\_\_img\书籍收藏.jpg](/md/blog.007.jpeg "C:/Users/Administrator/Desktop/temp111\1\\_\_\_\_img\书籍收藏.jpg")
书籍收藏实体属性图
...
![C:/Users/Administrator/Desktop/temp111\1\\_\_\_\_img\书籍借阅.jpg](/md/blog.009.jpeg "C:/Users/Administrator/Desktop/temp111\1\\_\_\_\_img\书籍借阅.jpg")
书籍借阅实体属性图

（6）下图是书籍实体和其具备的属性。

![C:/Users/Administrator/Desktop/temp111\1\\_\_\_\_img\书籍.jpg](/md/blog.010.jpeg "C:/Users/Administrator/Desktop/temp111\1\\_\_\_\_img\书籍.jpg")
书籍实体属性图
...
![C:/Users/Administrator/Desktop/temp111\1\\_\_\_\_img\罚金信息.jpg](/md/blog.012.jpeg "C:/Users/Administrator/Desktop/temp111\1\\_\_\_\_img\罚金信息.jpg")
罚金信息实体属性图

（9）下图是出入库实体和其具备的属性。

![C:/Users/Administrator/Desktop/temp111\1\\_\_\_\_img\出入库.jpg](/md/blog.013.jpeg "C:/Users/Administrator/Desktop/temp111\1\\_\_\_\_img\出入库.jpg")
出入库实体属性图

（10）下图是每日盘点实体和其具备的属性。

![C:/Users/Administrator/Desktop/temp111\1\\_\_\_\_img\每日盘点.jpg](/md/blog.014.jpeg "C:/Users/Administrator/Desktop/temp111\1\\_\_\_\_img\每日盘点.jpg")
每日盘点实体属性图

（11）下图是书籍评价实体和其具备的属性。

![C:/Users/Administrator/Desktop/temp111\1\\_\_\_\_img\书籍评价.jpg](/md/blog.015.jpeg "C:/Users/Administrator/Desktop/temp111\1\\_\_\_\_img\书籍评价.jpg")
书籍评价实体属性图
...
|3|fajin\_price|BigDecimal|缴纳金额|是|
|4|fajin\_content|String|缴纳原因|是|
...
|3|pandian\_num|Integer|盘点数量|是|
|4|pandian\_content|String|备注|是|
|5|insert\_time|Date|添加时间|是|
|6|create\_time|Date|创建时间|是|
表4.6书籍表
...
|4|shuji\_zuozhe|String|书籍作者|是|
|5|shuji\_chubanshe|String|出版社|是|
|6|shuji\_photo|String|书籍照片|是|
|7|shuji\_types|Integer|书籍类型|是|
|8|shujia\_types|Integer|所在书架|是|
|9|shujia\_address|String|详细地址|是|
|10|shuji\_kucun\_number|Integer|书籍库存|是|
|11|shuji\_clicknum|Integer|热度|是|
|12|shuji\_content|String|书籍介绍|是|
|13|shuji\_delete|Integer|逻辑删除|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|shuji\_churu\_inout\_uuid\_number|String|出入库流水号|是|
|3|shuji\_churu\_inout\_name|String|出入库名称|是|
|4|shuji\_churu\_inout\_types|Integer|出入库类型|是|
|5|shuji\_churu\_inout\_content|String|备注|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|shuji\_churu\_inout\_id|Integer|出入库|是|
|3|shuji\_id|Integer|书籍|是|
|4|shuji\_churu\_inout\_list\_number|Integer|操作数量|是|
...
|2|shuji\_id|Integer|书籍|是|
|3|yonghu\_id|Integer|用户|是|
|4|shuji\_commentback\_text|String|评价内容|是|
...
|2|shuji\_id|Integer|书籍|是|
|3|yonghu\_id|Integer|用户|是|
|4|shuji\_yuyue\_time|Date|借阅时间|是|
|5|shuji\_yuyue\_num|Integer|借阅天数|是|
|6|shuji\_yuyue\_types|Integer|借阅状态|是|
|7|shuji\_yuyue\_delete|Integer|逻辑删除|是|
